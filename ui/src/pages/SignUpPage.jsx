...
const SignUpPage = () => {
  // State variables to store full name, email, password, and error
  ...
  return (
    <div className=" h-1/2 flex items-center m-auto justify-center bg-red-500 py-12 px-4 sm:px-6 lg:px-8">
